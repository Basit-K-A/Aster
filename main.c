...
/* Lexes and prints every token from the given source until EOF */
static void lexAll(const char* source) {
    Lexer lexer;
...
int main(void) {
    ...
    printf("\n=== Phase 1 complete. Run tests before continuing. ===\n");
    return 0;
}
